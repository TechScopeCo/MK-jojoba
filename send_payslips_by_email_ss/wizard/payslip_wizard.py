...
class PayslipWizard(models.TransientModel):
    ...
    months = fields.Selection([('6_month', '6 Months'), ('1_year', '1 Year')],
                              string='Duration')
            ...
            if rec.slip_ids:
                ...
                if duration:
                    try:
                        ...
                        template_id = False
                    pdf_bin, format = self.env['ir.actions.report']._render_qweb_pdf('hr_payroll.report_payslip_lang', res_ids=duration.ids)
